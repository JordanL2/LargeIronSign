...
public record LargeIronSignScreenOpenPayload(BlockPos pos) implements CustomPayload {
    ...
    public static final CustomPayload.Id<LargeIronSignScreenOpenPayload> PACKET_ID = new CustomPayload.Id<>(new Identifier(LargeIronSign.MOD_ID, LargeIronSignBlock.PATH + "_screen_open"));
